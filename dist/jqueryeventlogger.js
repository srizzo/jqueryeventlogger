/*! jQueryEventLogger - v0.0.1 - 2015-01-18
http://github.com/srizzo/jqueryeventlogger/* Copyright (c) 2015 Samuel Rizzo; Licensed MIT %> */
(function ($) {
  ...
  if (typeof jQueryEventLogger == "undefined") {
    ...
    console.info("The events defined in jQueryEventLogger.IGNORE_EVENTS will be ignored. Currently, these are:")
    ...
    console.info("Helpers:\n" +
      ...
      "  To debug an event:                                                      debug(jQueryEventLogger.handler(id))\n" +
      "  To remove debug from a specific event:                                  undebug(jQueryEventLogger.handler(id))\n" +
      "  To inspect the event handler's source code (Google Chrome):             inspect(jQueryEventLogger.handler(id))"
    );
  }
